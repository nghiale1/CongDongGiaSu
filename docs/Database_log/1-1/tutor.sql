...
(7, 'client/svg/teacher_male.svg', NULL, NULL, NULL, 'gia sư 1', 'Nam', NULL, NULL, 'Đại học Cần Thơ - Can tho University, Đường 3/2, Xuân Khánh, Ninh Kiều, Cần Thơ, Vietnam', NULL, NULL, NULL, NULL, 27, '2021-01-04 14:57:29', '0000-00-00 00:00:00');
...
(20, 'admin', '$2y$10$f9t9aysLa9OA2xLPMpxym.R.E8pspfBNOt9WxehYMgUDzvhe9bPFa', 'Admin', 'jVodfuPsQeZ1hIuEwrqZUOg1Pgbe8KLi3yTyPq0WO7XqiJ42uU5ak3aqOOY2'),
(27, 'giasu1', '$2y$10$ZR/MBErtzbK2y4SchtFgfO38yE12YBIQYkK6bAV1m1mJcovgHUGgW', 'GiaSu', 'HRZrQibwPnrlao3LhdIjQHXK7gyHoWKfWvzCfmNHsdZxunOiVqwmIrmmhlbK');
...
--
ALTER TABLE `hocvien`
  MODIFY `hv_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `taikhoan`
  MODIFY `tk_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
--
ALTER TABLE `thumuchv`
  MODIFY `tmhv_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
