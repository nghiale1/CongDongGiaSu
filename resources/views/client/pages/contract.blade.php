                ...
                <table class="table table-borderless text-left" width='595px'>
                        ...
                        <tr>
                                ...
                                <td>Hôm nay, ngày <input type="text" class="date">
                                        ...
                                        năm<input type="text" class="date">tại (địa điểm)<input type="text">. chúng tôi
                                        gồm
                                        có:
                                </td>
                        </tr>
                        ...
                        <tr>
                                ...
                                <td>Sau khi trao đổi và bàn bạc hai bên đi đến thống nhất lập hợp đồng dịch vụ với nội
                        ...
                        <tr>
                                ...
                                <td>Bên A đồng ý để bên B (Là:<input type="text">) làm gia sư dạy kèm các
                                        môn:<input type="text"> lớp:<input type="text"> cho cháu (nêu họ, tên, tuổi từng
                        ...
                        <tr>
                                ...
                                <td>- Thời gian học theo lịch sau: vào các ngày:. kể từ ngày<input type="text">
                                        ...
                                        đến ngày<input type="text"> tháng<input type="text"> năm<input type="text"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                                ...
                                <td>- Bên A đồng ý trả cho bên B một giờ giảng cho một cháu là <input type="text"> đồng
                                </td>
                        </tr>
                        <tr>

                                <td>- Số tiền này sẽ được thanh toán hàng tuần vào cuối giờ giảng của ngày thứ bảy.</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                                ...
                                <td>- Bảo đảm địa điểm, thời gian, dụng cụ giảng dạy và phương tiện giúp cho học sinh
                        ...
                        <tr>
                                ...
                                <td>- Bảo đảm giờ học cho hai cháu đúng lịch (nếu vì một lý do nào đó mà phải nghỉ dạy
                                        phải điện thoại báo trước cho bên A ít nhất là 3 giờ và phải dạy bù vào một ngày
                                        khác do hai bên thỏa thuận ngay sau đó, nhưng số buổi nghỉ không được quá 3
                                        buổi/tháng.</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                                ...
                                <td>- Giữ gìn bí mật về những thông tin của gia cảnh trong suốt thời gian giảng dạy cũng
                                        như sau này (hoặc nói cách khác là không làm phương hại đến gia đình của bên A)
                                        mà trong thời gian giảng dạy tại gia đình.</td>
                        </tr>
                        <tr>

                                <td>- Không được chuyển giao nghĩa vụ cho người thứ ba nếu chưa được bên A chấp nhận.
                                </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                                ...
                                <td>- Sau thời gian học tập là một tháng nếu xét thấy trình độ cũng như học lực của các
                                        cháu hoặc cháu không đạt được hiệu quả như mong muốn thì bên B có quyền
                                        ngưng hợp đồng trước thời hạn.</td>
                        </tr>
                        <tr>

                                <td>- Hai bên cam kết thực hiện đầy đủ các điều khoản ghi trong hợp đồng, nếu có vấn đề
                                        bất lợi gì phát sinh, các bên phải chủ động trao đổi, bàn bạc giúp đỡ lẫn nhau
