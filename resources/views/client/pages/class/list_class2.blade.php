    ...
    <div class="row">
        <div class="col-md-3 opensan">
            ...
            <div class="medium-hide">
                ...
                <form action="{{route('search.match')}}" method="get" id="frmSort">
            ...
            <br>
            <div class="voice">
                <form action="{{route('search.match')}}" method="get" id="frmVoice">
                    <input type="hidden" name="search" value="{{$search}}">
            ...
            <div class="gender">
                ...
                <form action="{{route('search.match')}}" method="get" id="frmGender">
                    <input type="hidden" name="search" value="{{$search}}">
            ...
            <div class="level-student">
                ...
                <form action="{{route('search.match')}}" method="get" id="frmLevel">
                    <input type="hidden" name="search" value="{{$search}}">
