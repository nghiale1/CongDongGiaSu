...
<link rel="stylesheet" href="{{asset('client/assets/vendor/bootstrap-fileinput/fileinput.min.css')}}">
...
<script src="{{asset('client/assets/vendor/bootstrap-fileinput/jquery-3.3.1.min.js')}}"></script>
...
<script src="{{asset('client/assets/vendor/bootstrap-fileinput/purify.min.js')}}" type="text/javascript"></script>
...
<script src="{{asset('client/assets/vendor/bootstrap-fileinput/fileinput.min.js')}}"></script>


<!-- optionally if you need a theme like font awesome theme you can include it as mentioned below -->
{{-- <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-fileinput/5.1.1/themes/fa/theme.js"></script> --}}
<script src="{{asset('client/assets/vendor/bootstrap-fileinput/theme.js')}}"></script>
